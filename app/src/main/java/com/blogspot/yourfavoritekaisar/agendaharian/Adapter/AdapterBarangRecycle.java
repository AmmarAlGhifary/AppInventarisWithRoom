package com.blogspot.yourfavoritekaisar.agendaharian.Adapter;
...
import com.blogspot.yourfavoritekaisar.agendaharian.R;
import com.blogspot.yourfavoritekaisar.agendaharian.RoomCreateActivity;
import com.blogspot.yourfavoritekaisar.agendaharian.RoomReadSingleActivity;
...
public class AdapterBarangRecycle extends RecyclerView.Adapter<AdapterBarangRecycle.ViewHolder> {

    private ArrayList<Barang> daftarBarang;
    private Context context;
    private AppDatabase db;

    public AdapterBarangRecycle(ArrayList<Barang> barangs, Context ctx){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.cvMain.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                Button editButton = dialog.findViewById(R.id.bt_edit_nama);
                Button delButton = dialog.findViewById(R.id.bt_delete_nama);
